...
class LLMProvider(ABC):
    ...
    def api_format(self) -> str:
        ...
        Returns "anthropic" by default. Subclasses like OpenAICompatProvider
        override this to return "openai".
        """
        return "anthropic"
...
"""Alias for LLMResponse -- used in public API signatures."""

ToolCall = ToolCallRequest
"""Alias for ToolCallRequest -- used in public API signatures."""
