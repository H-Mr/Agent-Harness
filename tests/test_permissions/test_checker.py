...
from agent_harness.permissions import PermissionChecker, PermissionMode
from agent_harness.permissions.checker import SENSITIVE_PATH_PATTERNS
...
def test_invalid_pattern_rule_is_skipped_and_warns(bad_rule, caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="agent_harness.permissions.checker"):
...
class TestSensitivePathProtection:
    ...
    def test_full_auto_blocks_sensitive_paths(self):
        ...
        for path in (
            ...
            "/home/user/.agent-harness/credentials.json",
            "/home/user/.agent-harness/copilot_auth.json",
        ):
    ...
    def test_every_builtin_pattern_has_coverage(self, pattern):
        ...
        example_paths = {
            ...
            "*/.agent-harness/credentials.json": "/home/u/.agent-harness/credentials.json",
            "*/.agent-harness/copilot_auth.json": "/home/u/.agent-harness/copilot_auth.json",
        }
