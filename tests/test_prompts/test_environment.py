"""Tests for agent_harness.prompts.environment."""
...
from agent_harness.prompts.environment import (
    EnvironmentInfo,
    detect_git_info,
    detect_os,
    detect_shell,
...
def test_detect_git_info_uses_devnull_for_git_subprocess(monkeypatch):
    ...
    monkeypatch.setattr("agent_harness.prompts.environment.subprocess.run", _fake_run)
